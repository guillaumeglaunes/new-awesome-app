...
var CONTRACT_NAME = "dev-1637411887245-44431757490440" || 'new-awesome-app';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/Users/guillaumeglaunes", "/.near/validator_key.json"),
...
document.querySelector('input#greeting').oninput = function (event) {
  if (event.target.value !== currentGreeting) {
    submitButton.disabled = false; //prevent from saving if same greeting as saved
  } else {
